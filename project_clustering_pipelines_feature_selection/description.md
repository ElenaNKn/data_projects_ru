...
Ноутбук проекта доступен по ссылке: ["Отбор признаков. Кластеризация данных"](https://github.com/ElenaNKn/data_projects_ru/blob/master/project_clustering_pipelines_feature_selection/project.ipynb)